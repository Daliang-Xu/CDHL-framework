...
Peng Liu, Daliang Xu, Hangbin Xu, Yufei Chen, Yanyan Liu, Feng Li, Deyin Hou, Heng Liang, Sui Zhang
...
9.Dataset_Blended water.xlsx
The measured water-quality parameters of the source water, UF permeate, and NF270 permeate used for blended-water quality calculation and DBP concentration prediction.

10.Water quality_Blended water.xlsx
Contains the water-quality parameters calculated according to the specified UF/NF270 blending ratios, together with the measured DBP concentrations of the blended samples. This dataset was used for external validation of the CDHL-Q framework.